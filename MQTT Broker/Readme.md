...
# HTTP Protocol
Since MQTT does not suit sending images. We will be using HTTP protocol instead. <br/>
Firstly, we have to install apache2 (server client) and adjust firewall using commands :
```
